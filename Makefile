...
SHELL            := /bin/bash
PROJECT          := github.com/wawilow/pulumi-bytebase
NODE_MODULE_NAME := @wawilow/pulumi-bytebase
TF_NAME          := bytebase
PROVIDER_PATH    := provider
PROVIDER_VERSION := 3.8.6
VERSION_PATH     := ${PROVIDER_PATH}/pkg/version.Version

JAVA_GEN         := pulumi-java-gen
JAVA_GEN_VERSION := v1.16.0
TFGEN            := pulumi-tfgen-bytebase
PROVIDER         := pulumi-resource-bytebase
...
upstream/.git:
	...
	git -c advice.detachedHead=false clone --depth 1 --branch 'v$(PROVIDER_VERSION)' 'https://github.com/bytebase/terraform-provider-bytebase' upstream
