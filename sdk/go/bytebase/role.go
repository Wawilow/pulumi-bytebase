...
func NewRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.RegisterResource("bytebase:index/role:Role", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.ReadResource("bytebase:index/role:Role", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The role unique resource id.
func (o RoleOutput) ResourceId() pulumi.StringOutput {
	return o.ApplyT(func(v *Role) pulumi.StringOutput { return v.ResourceId }).(pulumi.StringOutput)
}
