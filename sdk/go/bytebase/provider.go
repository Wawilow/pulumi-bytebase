...
func (r *Provider) TerraformConfig(ctx *pulumi.Context) (ProviderTerraformConfigResultOutput, error) {
	out, err := ctx.Call("pulumi:providers:bytebase/terraformConfig", nil, ProviderTerraformConfigResultOutput{}, r)
	if err != nil {
...
// The Bytebase service account key. If not provided in the configuration, you must set the `BYTEBASE_SERVICE_KEY` variable
// in the environment.
func (o ProviderOutput) ServiceKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Provider) pulumi.StringPtrOutput { return v.ServiceKey }).(pulumi.StringPtrOutput)
}
