...
class DatabaseCatalogSchemaTableArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] classification: The classification id
        """
...
if not MYPY:
    class DatabaseCatalogSchemaTableColumnArgsDict(TypedDict):
        ...
        semantic_type: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class DatabaseCatalogSchemaTableColumnArgs:
    def __init__(__self__, *,
                 ...
                 semantic_type: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] classification: The classification id
        :param pulumi.Input[_builtins.str] semantic_type: The semantic type id
        """
        pulumi.set(__self__, "name", name)
        if classification is not None:
            pulumi.set(__self__, "classification", classification)
    ...
    def semantic_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The semantic type id
        """
    ...
    def semantic_type(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class GroupMemberArgs:
    def __init__(__self__, *,
                 ...
                 role: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] member: The member in users/{email} format.
        :param pulumi.Input[_builtins.str] role: The member's role in the group, should be OWNER or MEMBER.
        """
...
if not MYPY:
    class InstanceDataSourceArgsDict(TypedDict):
        ...
        """
        ssl_key: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class InstanceDataSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] host: Host or socket for your instance, or the account name if the instance type is Snowflake.
        :param pulumi.Input[_builtins.str] id: The unique data source id in this instance.
        :param pulumi.Input[_builtins.str] port: The port for your instance.
        :param pulumi.Input[_builtins.str] type: The data source type. Should be ADMIN or READ_ONLY.
        :param pulumi.Input[_builtins.str] database: The database for the instance, you can set this if the engine type is POSTGRES.
        ...
        :param pulumi.Input[_builtins.str] password: The connection user password used by Bytebase to perform DDL and DML operations.
        :param pulumi.Input[_builtins.str] ssl_ca: The CA certificate. Optional, you can set this if the engine type is MYSQL, POSTGRES, TIDB or CLICKHOUSE.
        :param pulumi.Input[_builtins.str] ssl_cert: The client certificate. Optional, you can set this if the engine type is MYSQL, POSTGRES, TIDB or CLICKHOUSE.
        :param pulumi.Input[_builtins.str] ssl_key: The client key. Optional, you can set this if the engine type is MYSQL, POSTGRES, TIDB or CLICKHOUSE.
        :param pulumi.Input[_builtins.bool] use_ssl: Enable SSL connection. Required to use SSL certificates.
        :param pulumi.Input[_builtins.str] username: The connection user name used by Bytebase to perform DDL and DML operations.
        """
...
if not MYPY:
    class InstanceDataSourceExternalSecretAwsSecretsManagerArgsDict(TypedDict):
        password_key_name: pulumi.Input[_builtins.str]
        """
...
class InstanceDataSourceExternalSecretAwsSecretsManagerArgs:
    def __init__(__self__, *,
                 ...
                 secret_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] password_key_name: The key name for the password.
        :param pulumi.Input[_builtins.str] secret_name: The secret name to store the password.
        """
    ...
    def password_key_name(self) -> pulumi.Input[_builtins.str]:
        """
        The key name for the password.
        """
    ...
    def password_key_name(self, value: pulumi.Input[_builtins.str]):
...
class InstanceDataSourceExternalSecretGcpSecretManagerArgs:
    def __init__(__self__, *,
                 secret_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] secret_name: The secret name should be like "projects/{project-id}/secrets/{secret-id}".
        """
        pulumi.set(__self__, "secret_name", secret_name)
...
class InstanceDataSourceExternalSecretVaultArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] engine_name: The name for secret engine.
        :param pulumi.Input[_builtins.str] password_key_name: The key name for the password.
        :param pulumi.Input[_builtins.str] secret_name: The secret name in the engine to store the password.
        :param pulumi.Input[_builtins.str] url: The Vault URL.
...
class InstanceDataSourceExternalSecretVaultAppRoleArgs:
    def __init__(__self__, *,
                 ...
                 secret_type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] role_id: The app role id.
        :param pulumi.Input[_builtins.str] secret: The secret id for the role without ttl.
        :param pulumi.Input[_builtins.str] secret_type: The secret id type, can be PLAIN (plain text for the secret) or ENVIRONMENT (envirionment name for the secret).
        """
...
if not MYPY:
    class PolicyDataSourceQueryPolicyArgsDict(TypedDict):
        disallow_ddl: NotRequired[pulumi.Input[_builtins.bool]]
        """
        Disallow running DDL statements in the SQL editor.
        """
        disallow_dml: NotRequired[pulumi.Input[_builtins.bool]]
        """
        Disallow running DML statements in the SQL editor.
        """
        restriction: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class PolicyDataSourceQueryPolicyArgs:
    def __init__(__self__, *,
                 disallow_ddl: Optional[pulumi.Input[_builtins.bool]] = None,
                 disallow_dml: Optional[pulumi.Input[_builtins.bool]] = None,
                 restriction: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.bool] disallow_ddl: Disallow running DDL statements in the SQL editor.
        :param pulumi.Input[_builtins.bool] disallow_dml: Disallow running DML statements in the SQL editor.
        :param pulumi.Input[_builtins.str] restriction: RESTRICTION_UNSPECIFIED means no restriction; FALLBACK will allows to query admin data sources when there is no read-only data source; DISALLOW will always disallow to query admin data sources.
        """
    ...
    def disallow_ddl(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Disallow running DDL statements in the SQL editor.
        """
    ...
    @disallow_ddl.setter
    def disallow_ddl(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "disallow_ddl", value)

    @_builtins.property
    @pulumi.getter(name="disallowDml")
    def disallow_dml(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Disallow running DML statements in the SQL editor.
        """
    ...
    @disallow_dml.setter
    def disallow_dml(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "disallow_dml", value)

    @_builtins.property
    @pulumi.getter
    def restriction(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        RESTRICTION_UNSPECIFIED means no restriction; FALLBACK will allows to query admin data sources when there is no read-only data source; DISALLOW will always disallow to query admin data sources.
        """
    ...
    @restriction.setter
    def restriction(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class PolicyDisableCopyDataPolicyArgs:
    def __init__(__self__, *,
                 enable: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enable: Restrict data copying
        """
...
if not MYPY:
    class PolicyGlobalMaskingPolicyRuleArgsDict(TypedDict):
        ...
        The unique rule id
        """
        semantic_type: pulumi.Input[_builtins.str]
        """
        The semantic type id
        """
...
class PolicyGlobalMaskingPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] condition: The condition expression
        :param pulumi.Input[_builtins.str] id: The unique rule id
        :param pulumi.Input[_builtins.str] semantic_type: The semantic type id
        :param pulumi.Input[_builtins.str] title: The title for the rule
        """
    ...
    @_builtins.property
    @pulumi.getter(name="semanticType")
    def semantic_type(self) -> pulumi.Input[_builtins.str]:
        """
        The semantic type id
        """
        return pulumi.get(self, "semantic_type")
    ...
    @semantic_type.setter
    def semantic_type(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "semantic_type", value)
...
class PolicyMaskingExceptionPolicyExceptionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] database: The database full name in instances/{instance resource id}/databases/{database name} format
        :param pulumi.Input[_builtins.str] member: The member in user:{email} or group:{email} format.
        :param pulumi.Input[_builtins.str] expire_timestamp: The expiration timestamp in YYYY-MM-DDThh:mm:ss.000Z format
        :param pulumi.Input[_builtins.str] reason: The reason for the masking exemption
        """
...
class PolicyRolloutPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.bool] automatic: If all check pass, the change will be rolled out and executed automatically.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] roles: If any roles are specified, Bytebase requires users with those roles to manually roll out the change.
        """
...
if not MYPY:
    class ProjectWebhookArgsDict(TypedDict):
        ...
        The webhook URL
        """
        direct_message: NotRequired[pulumi.Input[_builtins.bool]]
        """
...
class ProjectWebhookArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str],
                 url: pulumi.Input[_builtins.str],
                 direct_message: Optional[pulumi.Input[_builtins.bool]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] notification_types: notification_types is the list of activities types that the webhook is interested in. Bytebase will only send notifications to the webhook if the activity type is in the list.
        :param pulumi.Input[_builtins.str] title: The webhook title
        :param pulumi.Input[_builtins.str] type: The webhook type. Check https://github.com/bytebase/bytebase/blob/main/proto/v1/v1/project_service.proto#L449 for support types.
        :param pulumi.Input[_builtins.str] url: The webhook URL
        :param pulumi.Input[_builtins.bool] direct_message: If direct_message is set, the notification is sent directly to the persons and url will be ignored. Require IM integration for this function to work.
        :param pulumi.Input[_builtins.str] name: The webhook full name in projects/{resource id}/webhooks/{id} format.
        """
    ...
    def direct_message(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        If direct_message is set, the notification is sent directly to the persons and url will be ignored. Require IM integration for this function to work.
        """
    ...
    def direct_message(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class SettingApprovalFlowRuleFlowStepArgs:
    def __init__(__self__, *,
                 role: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] role: The role require to review in this step
        """
        pulumi.set(__self__, "role", role)
...
if not MYPY:
    class SettingClassificationArgsDict(TypedDict):
        ...
        """
        classification_from_config: NotRequired[pulumi.Input[_builtins.bool]]
        """
...
class SettingClassificationArgs:
    def __init__(__self__, *,
                 ...
                 title: pulumi.Input[_builtins.str],
                 classification_from_config: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.str] id: The classification unique uuid.
        :param pulumi.Input[_builtins.str] title: The classification title. Optional.
        :param pulumi.Input[_builtins.bool] classification_from_config: If true, we will only store the classification in the config. Otherwise we will get the classification from table/column comment, and write back to the schema metadata.
        """
    ...
    def classification_from_config(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        If true, we will only store the classification in the config. Otherwise we will get the classification from table/column comment, and write back to the schema metadata.
        """
    ...
    def classification_from_config(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class SettingClassificationClassificationArgs:
    def __init__(__self__, *,
                 ...
                 level: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] id: The classification unique id, must in {number}-{number} format.
        :param pulumi.Input[_builtins.str] title: The classification title.
        :param pulumi.Input[_builtins.str] description: The classification description.
        :param pulumi.Input[_builtins.str] level: The classification level id.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "title", title)
        if description is not None:
...
class SettingClassificationLevelArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] id: The classification level unique uuid.
        :param pulumi.Input[_builtins.str] title: The classification level title.
        :param pulumi.Input[_builtins.str] description: The classification level description.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "title", title)
        if description is not None:
...
class SettingEnvironmentSettingEnvironmentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] id: The environment unique id.
...
if not MYPY:
    class SettingPasswordRestrictionArgsDict(TypedDict):
        ...
        """
        password_rotation_in_seconds: NotRequired[pulumi.Input[_builtins.int]]
        """
...
class SettingPasswordRestrictionArgs:
    def __init__(__self__, *,
                 ...
                 password_rotation_in_seconds: Optional[pulumi.Input[_builtins.int]] = None,
                 require_letter: Optional[pulumi.Input[_builtins.bool]] = None,
                 require_number: Optional[pulumi.Input[_builtins.bool]] = None,
                 require_reset_password_for_first_login: Optional[pulumi.Input[_builtins.bool]] = None,
                 require_special_character: Optional[pulumi.Input[_builtins.bool]] = None,
                 require_uppercase_letter: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.int] min_length: min_length is the minimum length for password, should no less than 8.
        :param pulumi.Input[_builtins.int] password_rotation_in_seconds: password_rotation requires users to reset their password after the duration. The duration should be at least 86400 (one day).
        :param pulumi.Input[_builtins.bool] require_letter: require_letter requires the password must contains at least one letter, regardless of upper case or lower case.
        :param pulumi.Input[_builtins.bool] require_number: require_number requires the password must contains at least one number.
        :param pulumi.Input[_builtins.bool] require_reset_password_for_first_login: require*reset*password*for*first_login requires users to reset their password after the 1st login.
        :param pulumi.Input[_builtins.bool] require_special_character: require*special*character requires the password must contains at least one special character.
        :param pulumi.Input[_builtins.bool] require_uppercase_letter: require*uppercase*letter requires the password must contains at least one upper case letter.
        """
    ...
    def password_rotation_in_seconds(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        password_rotation requires users to reset their password after the duration. The duration should be at least 86400 (one day).
        """
    ...
    def password_rotation_in_seconds(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "password_rotation_in_seconds", value)

    @_builtins.property
    @pulumi.getter(name="requireLetter")
    def require_letter(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        require_letter requires the password must contains at least one letter, regardless of upper case or lower case.
        """
    ...
    def require_letter(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "require_letter", value)

    @_builtins.property
    @pulumi.getter(name="requireNumber")
    def require_number(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        require_number requires the password must contains at least one number.
        """
    ...
    def require_number(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "require_number", value)

    @_builtins.property
    @pulumi.getter(name="requireResetPasswordForFirstLogin")
    def require_reset_password_for_first_login(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        require*reset*password*for*first_login requires users to reset their password after the 1st login.
        """
    ...
    def require_reset_password_for_first_login(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "require_reset_password_for_first_login", value)

    @_builtins.property
    @pulumi.getter(name="requireSpecialCharacter")
    def require_special_character(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        require*special*character requires the password must contains at least one special character.
        """
    ...
    def require_special_character(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "require_special_character", value)

    @_builtins.property
    @pulumi.getter(name="requireUppercaseLetter")
    def require_uppercase_letter(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        require*uppercase*letter requires the password must contains at least one upper case letter.
        """
    ...
    def require_uppercase_letter(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class SettingSemanticTypeArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] id: The semantic type unique uuid.
        :param pulumi.Input[_builtins.str] title: The semantic type title. Required.
        :param pulumi.Input['SettingSemanticTypeAlgorithmArgs'] algorithm: The semantic type algorithm. Required.
        :param pulumi.Input[_builtins.str] description: The semantic type description. Optional.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "title", title)
...
if not MYPY:
    class SettingSemanticTypeAlgorithmFullMaskArgsDict(TypedDict):
        substitution: pulumi.Input[_builtins.str]
        """
...
class SettingSemanticTypeAlgorithmFullMaskArgs:
    def __init__(__self__, *,
                 substitution: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] substitution: Substitution is the string used to replace the original value, the max length of the string is 16 bytes.
        """
        pulumi.set(__self__, "substitution", substitution)

    @_builtins.property
    @pulumi.getter
    def substitution(self) -> pulumi.Input[_builtins.str]:
        """
        Substitution is the string used to replace the original value, the max length of the string is 16 bytes.
        """
...
if not MYPY:
    class SettingSemanticTypeAlgorithmInnerOuterMaskArgsDict(TypedDict):
        ...
        """
        suffix_len: pulumi.Input[_builtins.int]
        """
...
class SettingSemanticTypeAlgorithmInnerOuterMaskArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.int] prefix_len: The length of prefix.
        :param pulumi.Input[_builtins.str] substitution: Substitution is the string used to replace the inner or outer substring.
        :param pulumi.Input[_builtins.int] suffix_len: The length of suffix.
        :param pulumi.Input[_builtins.str] type: INNER or OUTER.
        """
    ...
    def prefix_len(self) -> pulumi.Input[_builtins.int]:
        """
        The length of prefix.
        """
    ...
    @prefix_len.setter
    def prefix_len(self, value: pulumi.Input[_builtins.int]):
    ...
    def suffix_len(self) -> pulumi.Input[_builtins.int]:
        """
        The length of suffix.
        """
    ...
    @suffix_len.setter
    def suffix_len(self, value: pulumi.Input[_builtins.int]):
...
if not MYPY:
    class SettingSemanticTypeAlgorithmMd5MaskArgsDict(TypedDict):
        salt: pulumi.Input[_builtins.str]
        """
...
class SettingSemanticTypeAlgorithmMd5MaskArgs:
    def __init__(__self__, *,
                 salt: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] salt: Salt is the salt value to generate a different hash that with the word alone.
        """
        pulumi.set(__self__, "salt", salt)

    @_builtins.property
    @pulumi.getter
    def salt(self) -> pulumi.Input[_builtins.str]:
        """
        Salt is the salt value to generate a different hash that with the word alone.
        """
    ...
    @salt.setter
    def salt(self, value: pulumi.Input[_builtins.str]):
...
class SettingSemanticTypeAlgorithmRangeMaskSliceArgs:
    def __init__(__self__, *,
                 ...
                 substitution: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.int] end: End is the stop index of the original value, should be less than the length of the original value.
        :param pulumi.Input[_builtins.int] start: Start is the start index of the original value, start from 0 and should be less than stop.
        :param pulumi.Input[_builtins.str] substitution: Substitution is the string used to replace the OriginalValue[start:end).
        """
...
if not MYPY:
    class SettingSqlQueryRestrictionArgsDict(TypedDict):
        maximum_result_rows: NotRequired[pulumi.Input[_builtins.int]]
        """
        The return rows limit. If the value <= 0, will be treated as no limit. The default value is -1.
        """
        maximum_result_size: NotRequired[pulumi.Input[_builtins.int]]
        """
...
class SettingSqlQueryRestrictionArgs:
    def __init__(__self__, *,
                 maximum_result_rows: Optional[pulumi.Input[_builtins.int]] = None,
                 maximum_result_size: Optional[pulumi.Input[_builtins.int]] = None):
        """
        :param pulumi.Input[_builtins.int] maximum_result_rows: The return rows limit. If the value <= 0, will be treated as no limit. The default value is -1.
        :param pulumi.Input[_builtins.int] maximum_result_size: The size limit in bytes. The default value is 100MB, we will use the default value if the setting not exists, or the limit <= 0.
        """
    ...
    def maximum_result_rows(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        The return rows limit. If the value <= 0, will be treated as no limit. The default value is -1.
        """
    ...
    def maximum_result_rows(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "maximum_result_rows", value)

    @_builtins.property
    @pulumi.getter(name="maximumResultSize")
    def maximum_result_size(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        The size limit in bytes. The default value is 100MB, we will use the default value if the setting not exists, or the limit <= 0.
        """
    ...
    def maximum_result_size(self, value: Optional[pulumi.Input[_builtins.int]]):
...
if not MYPY:
    class SettingWorkspaceProfileArgsDict(TypedDict):
        ...
        """
        database_change_mode: NotRequired[pulumi.Input[_builtins.str]]
        """
        The workspace database change mode, support EDITOR or PIPELINE. Default PIPELINE
        """
        disallow_password_signin: NotRequired[pulumi.Input[_builtins.bool]]
        """
        Whether to disallow password signin (except workspace admins). Require ENTERPRISE subscription
        """
        disallow_signup: NotRequired[pulumi.Input[_builtins.bool]]
        """
        ...
        """
        enforce_identity_domain: NotRequired[pulumi.Input[_builtins.bool]]
        """
        ...
        """
        maximum_role_expiration_in_seconds: NotRequired[pulumi.Input[_builtins.int]]
        """
        ...
        """
        token_duration_in_seconds: NotRequired[pulumi.Input[_builtins.int]]
        """
...
class SettingWorkspaceProfileArgs:
    def __init__(__self__, *,
                 ...
                 database_change_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 disallow_password_signin: Optional[pulumi.Input[_builtins.bool]] = None,
                 disallow_signup: Optional[pulumi.Input[_builtins.bool]] = None,
                 domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 enforce_identity_domain: Optional[pulumi.Input[_builtins.bool]] = None,
                 external_url: Optional[pulumi.Input[_builtins.str]] = None,
                 maximum_role_expiration_in_seconds: Optional[pulumi.Input[_builtins.int]] = None,
                 token_duration_in_seconds: Optional[pulumi.Input[_builtins.int]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] database_change_mode: The workspace database change mode, support EDITOR or PIPELINE. Default PIPELINE
        :param pulumi.Input[_builtins.bool] disallow_password_signin: Whether to disallow password signin (except workspace admins). Require ENTERPRISE subscription
        :param pulumi.Input[_builtins.bool] disallow_signup: Disallow self-service signup, users can only be invited by the owner. Require PRO subscription.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] domains: The workspace domain, e.g. bytebase.com. Required for the group
        :param pulumi.Input[_builtins.bool] enforce_identity_domain: Only user and group from the domains can be created and login.
        :param pulumi.Input[_builtins.str] external_url: The URL user visits Bytebase. The external URL is used for: 1. Constructing the correct callback URL when configuring the VCS provider. The callback URL points to the frontend; 2. Creating the correct webhook endpoint when configuring the project GitOps workflow. The webhook endpoint points to the backend.
        :param pulumi.Input[_builtins.int] maximum_role_expiration_in_seconds: The max duration in seconds for role expired. If the value is less than or equal to 0, we will remove the setting. AKA no limit.
        :param pulumi.Input[_builtins.int] token_duration_in_seconds: The duration for login token in seconds. The duration should be at least 3600 (one hour).
        """
    ...
    def database_change_mode(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The workspace database change mode, support EDITOR or PIPELINE. Default PIPELINE
        """
    ...
    def database_change_mode(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "database_change_mode", value)

    @_builtins.property
    @pulumi.getter(name="disallowPasswordSignin")
    def disallow_password_signin(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Whether to disallow password signin (except workspace admins). Require ENTERPRISE subscription
        """
    ...
    def disallow_password_signin(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "disallow_password_signin", value)

    @_builtins.property
    @pulumi.getter(name="disallowSignup")
    def disallow_signup(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Disallow self-service signup, users can only be invited by the owner. Require PRO subscription.
        """
    ...
    def disallow_signup(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def enforce_identity_domain(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Only user and group from the domains can be created and login.
        """
    ...
    def enforce_identity_domain(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def maximum_role_expiration_in_seconds(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        The max duration in seconds for role expired. If the value is less than or equal to 0, we will remove the setting. AKA no limit.
        """
    ...
    def maximum_role_expiration_in_seconds(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "maximum_role_expiration_in_seconds", value)

    @_builtins.property
    @pulumi.getter(name="tokenDurationInSeconds")
    def token_duration_in_seconds(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        The duration for login token in seconds. The duration should be at least 3600 (one hour).
        """
    ...
    def token_duration_in_seconds(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class SettingWorkspaceProfileAnnouncementArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] level: The alert level of announcement
        :param pulumi.Input[_builtins.str] text: The text of announcement. Leave it as empty string can clear the announcement
        :param pulumi.Input[_builtins.str] link: The optional link, user can follow the link to check extra details
        """
        pulumi.set(__self__, "level", level)
...
if not MYPY:
    class GetPolicyDataSourceQueryPolicyArgsDict(TypedDict):
        disallow_ddl: NotRequired[_builtins.bool]
        """
        Disallow running DDL statements in the SQL editor.
        """
        disallow_dml: NotRequired[_builtins.bool]
        """
        Disallow running DML statements in the SQL editor.
        """
        restriction: NotRequired[_builtins.str]
        """
        RESTRICTION_UNSPECIFIED means no restriction; FALLBACK will allows to query admin data sources when there is no read-only data source; DISALLOW will always disallow to query admin data sources.
        """
elif False:
...
class GetPolicyDataSourceQueryPolicyArgs:
    ...
    @disallow_ddl.setter
    def disallow_ddl(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "disallow_ddl", value)
    ...
    @disallow_dml.setter
    def disallow_dml(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "disallow_dml", value)
    ...
    @restriction.setter
    def restriction(self, value: Optional[_builtins.str]):
        pulumi.set(self, "restriction", value)
...
if not MYPY:
    class GetPolicyGlobalMaskingPolicyRuleArgsDict(TypedDict):
        ...
        The semantic type id
        """
        title: NotRequired[_builtins.str]
        """
        The title for the rule
        """
elif False:
...
class GetPolicyGlobalMaskingPolicyRuleArgs:
    ...
    @semantic_type.setter
    def semantic_type(self, value: _builtins.str):
        pulumi.set(self, "semantic_type", value)
    ...
    @title.setter
    def title(self, value: Optional[_builtins.str]):
        pulumi.set(self, "title", value)
...
if not MYPY:
    class GetPolicyMaskingExceptionPolicyExceptionArgsDict(TypedDict):
        ...
        table: _builtins.str
        reason: NotRequired[_builtins.str]
        """
        The reason for the masking exemption
        """
elif False:
...
class GetPolicyMaskingExceptionPolicyExceptionArgs:
    ...
    @column.setter
    def column(self, value: _builtins.str):
        pulumi.set(self, "column", value)
    ...
    @expire_timestamp.setter
    def expire_timestamp(self, value: _builtins.str):
        pulumi.set(self, "expire_timestamp", value)
    ...
    @table.setter
    def table(self, value: _builtins.str):
        pulumi.set(self, "table", value)
    ...
    @reason.setter
    def reason(self, value: Optional[_builtins.str]):
        pulumi.set(self, "reason", value)


if not MYPY:
    class GetPolicyRolloutPolicyArgsDict(TypedDict):
        automatic: NotRequired[_builtins.bool]
        """
        If all check pass, the change will be rolled out and executed automatically.
        """
        roles: NotRequired[Sequence[_builtins.str]]
        """
        If any roles are specified, Bytebase requires users with those roles to manually roll out the change.
        """
elif False:
...
class GetPolicyRolloutPolicyArgs:
    ...
    @automatic.setter
    def automatic(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "automatic", value)
    ...
    @roles.setter
    def roles(self, value: Optional[Sequence[_builtins.str]]):
        pulumi.set(self, "roles", value)
...
class GetSettingApprovalFlowRuleConditionArgs:
    ...
    @level.setter
    def level(self, value: _builtins.str):
        pulumi.set(self, "level", value)
...
class GetSettingClassificationArgs:
    ...
    @classification_from_config.setter
    def classification_from_config(self, value: _builtins.bool):
        pulumi.set(self, "classification_from_config", value)
...
if not MYPY:
    class GetSettingEnvironmentSettingEnvironmentArgsDict(TypedDict):
        ...
        The environment color.
        """
        protected: NotRequired[_builtins.bool]
        """
        The environment is protected or not.
        """
elif False:
...
class GetSettingEnvironmentSettingEnvironmentArgs:
    ...
    @protected.setter
    def protected(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "protected", value)


if not MYPY:
    class GetSettingPasswordRestrictionArgsDict(TypedDict):
        min_length: NotRequired[_builtins.int]
        """
        min_length is the minimum length for password, should no less than 8.
        """
        password_rotation_in_seconds: NotRequired[_builtins.int]
        """
        password_rotation requires users to reset their password after the duration. The duration should be at least 86400 (one day).
        """
        require_letter: NotRequired[_builtins.bool]
        """
        require_letter requires the password must contains at least one letter, regardless of upper case or lower case.
        """
        require_number: NotRequired[_builtins.bool]
        """
        require_number requires the password must contains at least one number.
        """
        require_reset_password_for_first_login: NotRequired[_builtins.bool]
        """
        require*reset*password*for*first_login requires users to reset their password after the 1st login.
        """
        require_special_character: NotRequired[_builtins.bool]
        """
        require*special*character requires the password must contains at least one special character.
        """
        require_uppercase_letter: NotRequired[_builtins.bool]
        """
        require*uppercase*letter requires the password must contains at least one upper case letter.
        """
elif False:
...
class GetSettingPasswordRestrictionArgs:
    ...
    @min_length.setter
    def min_length(self, value: Optional[_builtins.int]):
        pulumi.set(self, "min_length", value)
    ...
    @password_rotation_in_seconds.setter
    def password_rotation_in_seconds(self, value: Optional[_builtins.int]):
        pulumi.set(self, "password_rotation_in_seconds", value)
    ...
    @require_letter.setter
    def require_letter(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "require_letter", value)
    ...
    @require_number.setter
    def require_number(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "require_number", value)
    ...
    @require_reset_password_for_first_login.setter
    def require_reset_password_for_first_login(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "require_reset_password_for_first_login", value)
    ...
    @require_special_character.setter
    def require_special_character(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "require_special_character", value)
    ...
    @require_uppercase_letter.setter
    def require_uppercase_letter(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "require_uppercase_letter", value)
...
class GetSettingSemanticTypeAlgorithmFullMaskArgs:
    ...
    @substitution.setter
    def substitution(self, value: _builtins.str):
        pulumi.set(self, "substitution", value)
...
class GetSettingSemanticTypeAlgorithmInnerOuterMaskArgs:
    ...
    @prefix_len.setter
    def prefix_len(self, value: _builtins.int):
        pulumi.set(self, "prefix_len", value)
    ...
    @suffix_len.setter
    def suffix_len(self, value: _builtins.int):
        pulumi.set(self, "suffix_len", value)
...
class GetSettingSemanticTypeAlgorithmMd5MaskArgs:
    ...
    @salt.setter
    def salt(self, value: _builtins.str):
        pulumi.set(self, "salt", value)
...
if not MYPY:
    class GetSettingSqlQueryRestrictionArgsDict(TypedDict):
        maximum_result_rows: NotRequired[_builtins.int]
        """
        The return rows limit. If the value <= 0, will be treated as no limit. The default value is -1.
        """
        maximum_result_size: NotRequired[_builtins.int]
        """
        The size limit in bytes. The default value is 100MB, we will use the default value if the setting not exists, or the limit <= 0.
        """
elif False:
...
class GetSettingSqlQueryRestrictionArgs:
    ...
    @maximum_result_rows.setter
    def maximum_result_rows(self, value: Optional[_builtins.int]):
        pulumi.set(self, "maximum_result_rows", value)
    ...
    @maximum_result_size.setter
    def maximum_result_size(self, value: Optional[_builtins.int]):
        pulumi.set(self, "maximum_result_size", value)
...
if not MYPY:
    class GetSettingWorkspaceProfileArgsDict(TypedDict):
        ...
        Custom announcement. Will show as a banner in the Bytebase UI. Require ENTERPRISE subscription.
        """
        database_change_mode: NotRequired[_builtins.str]
        """
        The workspace database change mode, support EDITOR or PIPELINE. Default PIPELINE
        """
        disallow_password_signin: NotRequired[_builtins.bool]
        """
        Whether to disallow password signin (except workspace admins). Require ENTERPRISE subscription
        """
        disallow_signup: NotRequired[_builtins.bool]
        """
        Disallow self-service signup, users can only be invited by the owner. Require PRO subscription.
        """
        ...
        The workspace domain, e.g. bytebase.com. Required for the group
        """
        enforce_identity_domain: NotRequired[_builtins.bool]
        """
        Only user and group from the domains can be created and login.
        """
        external_url: NotRequired[_builtins.str]
        """
        The URL user visits Bytebase. The external URL is used for: 1. Constructing the correct callback URL when configuring the VCS provider. The callback URL points to the frontend; 2. Creating the correct webhook endpoint when configuring the project GitOps workflow. The webhook endpoint points to the backend.
        """
        maximum_role_expiration_in_seconds: NotRequired[_builtins.int]
        """
        The max duration in seconds for role expired. If the value is less than or equal to 0, we will remove the setting. AKA no limit.
        """
        token_duration_in_seconds: NotRequired[_builtins.int]
        """
        The duration for login token in seconds. The duration should be at least 3600 (one hour).
        """
elif False:
...
class GetSettingWorkspaceProfileArgs:
    ...
    @database_change_mode.setter
    def database_change_mode(self, value: Optional[_builtins.str]):
        pulumi.set(self, "database_change_mode", value)
    ...
    @disallow_password_signin.setter
    def disallow_password_signin(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "disallow_password_signin", value)
    ...
    @disallow_signup.setter
    def disallow_signup(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "disallow_signup", value)
    ...
    @enforce_identity_domain.setter
    def enforce_identity_domain(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "enforce_identity_domain", value)
    ...
    @external_url.setter
    def external_url(self, value: Optional[_builtins.str]):
        pulumi.set(self, "external_url", value)
    ...
    @maximum_role_expiration_in_seconds.setter
    def maximum_role_expiration_in_seconds(self, value: Optional[_builtins.int]):
        pulumi.set(self, "maximum_role_expiration_in_seconds", value)
    ...
    @token_duration_in_seconds.setter
    def token_duration_in_seconds(self, value: Optional[_builtins.int]):
        pulumi.set(self, "token_duration_in_seconds", value)
...
if not MYPY:
    class GetSettingWorkspaceProfileAnnouncementArgsDict(TypedDict):
        ...
        The text of announcement. Leave it as empty string can clear the announcement
        """
        link: NotRequired[_builtins.str]
        """
        The optional link, user can follow the link to check extra details
        """
elif False:
...
class GetSettingWorkspaceProfileAnnouncementArgs:
    ...
    @link.setter
    def link(self, value: Optional[_builtins.str]):
        pulumi.set(self, "link", value)
