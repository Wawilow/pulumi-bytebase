...
class GetGroupResult:
    ...
    def matched_databases(self) -> Sequence[_builtins.str]:
        """
...
def get_group(project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project: The project fullname in projects/{id} format.
    :param _builtins.str resource_id: The database group unique resource id.
    """
    __args__ = dict()
...
def get_group_output(project: Optional[pulumi.Input[_builtins.str]] = None,
