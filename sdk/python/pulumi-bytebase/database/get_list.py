...
class GetListResult:
    ...
    @_builtins.property
    @pulumi.getter
    def engines(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def exclude_unassigned(self) -> Optional[_builtins.bool]:
        """
...
def get_list(engines: Optional[Sequence[_builtins.str]] = None,
             environment: Optional[_builtins.str] = None,
             exclude_unassigned: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] engines: Filter databases by engines.
    :param _builtins.str environment: The environment full name. Filter databases by environment.
    :param _builtins.bool exclude_unassigned: If not include unassigned databases in the response.
    :param _builtins.str instance: The instance full name. Filter databases by instance.
    :param Mapping[str, _builtins.str] labels: Filter databases by labels
    :param _builtins.str project: The project full name. Filter databases by project.
    :param _builtins.str query: Filter databases by name with wildcard
    """
    __args__ = dict()
...
def get_list_output(engines: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                    environment: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                    exclude_unassigned: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                    instance: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
