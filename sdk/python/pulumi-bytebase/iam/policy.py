...
class PolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] parent: The IAM policy parent name for the policy, support "projects/{resource id}" or "workspaces/-"
        """
...
class Policy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            iam_policy: Optional[pulumi.Input[Union['PolicyIamPolicyArgs', 'PolicyIamPolicyArgsDict']]] = None,
            parent: Optional[pulumi.Input[_builtins.str]] = None) -> 'Policy':
        """
