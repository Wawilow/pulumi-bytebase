...
class GetListResult:
    ...
    def exclude_default(self) -> Optional[_builtins.bool]:
        """
...
def get_list(exclude_default: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool exclude_default: If not include the default project in the response.
    :param _builtins.str query: Filter projects by name or resource id with wildcard.
    :param _builtins.str state: Filter projects by state. Default ACTIVE.
    """
    __args__ = dict()
...
def get_list_output(exclude_default: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
