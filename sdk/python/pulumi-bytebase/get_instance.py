...
class GetInstanceResult:
    ...
    def list_all_databases(self) -> Optional[_builtins.bool]:
        """
...
def get_instance(list_all_databases: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool list_all_databases: List all databases in this instance. If false, will only list 500 databases.
...
def get_instance_output(list_all_databases: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
