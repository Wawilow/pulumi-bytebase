...
def get_list(engines: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] engines: Filter instances by engines.
    :param _builtins.str environment: The environment full name. Filter instances by environment.
    :param _builtins.str host: Filter instances by host.
    :param _builtins.str port: Filter instances by port.
    :param _builtins.str project: The project full name. Filter instances by project.
    :param _builtins.str query: Filter instances by name or resource id with wildcard
    :param _builtins.str state: Filter instances by state. Default ACTIVE.
    """
    __args__ = dict()
