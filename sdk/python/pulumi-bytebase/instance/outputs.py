...
class GetListInstanceResult(dict):
    def __init__(__self__, *,
                 ...
                 maximum_connections: _builtins.int,
                 name: _builtins.str,
                 resource_id: _builtins.str,
                 sync_interval: _builtins.int,
                 title: _builtins.str):
        """
        :param _builtins.bool activation: Whether assign license for this instance or not.
        :param _builtins.str engine: The instance engine. Support MYSQL, POSTGRES, TIDB, SNOWFLAKE, CLICKHOUSE, MONGODB, SQLITE, REDIS, ORACLE, SPANNER, MSSQL, REDSHIFT, MARIADB, OCEANBASE, COCKROACHDB.
        :param _builtins.str engine_version: The engine version.
        :param _builtins.str environment: The environment name for your instance in "environments/{resource id}" format.
        :param _builtins.str external_link: The external console URL managing this instance (e.g. AWS RDS console, your in-house DB instance console)
        :param _builtins.int maximum_connections: The maximum number of connections. The default value is 10.
        :param _builtins.str name: The instance full name in instances/{resource id} format.
        :param _builtins.str resource_id: The instance unique resource id.
        :param _builtins.int sync_interval: How often the instance is synced in seconds. Default 0, means never sync.
        :param _builtins.str title: The instance title.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def activation(self) -> _builtins.bool:
        """
    ...
    def external_link(self) -> _builtins.str:
        """
    ...
    def maximum_connections(self) -> _builtins.int:
        """
    ...
    def sync_interval(self) -> _builtins.int:
        """
