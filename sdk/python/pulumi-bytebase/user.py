...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] email: The user email.
        :param pulumi.Input[_builtins.str] title: The user title.
        :param pulumi.Input[_builtins.str] password: The user login password.
        :param pulumi.Input[_builtins.str] phone: The user phone.
        :param pulumi.Input[_builtins.str] type: The user type, should be USER or SERVICE_ACCOUNT. Cannot change after creation.
        """
...
class _UserState:
    def __init__(__self__, *,
                 ...
                 last_change_password_time: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] email: The user email.
        :param pulumi.Input[_builtins.str] last_change_password_time: The user last change password time.
        :param pulumi.Input[_builtins.str] last_login_time: The user last login time.
        :param pulumi.Input[_builtins.bool] mfa_enabled: The mfa_enabled flag means if the user has enabled MFA.
        :param pulumi.Input[_builtins.str] name: The user name in users/{user id or email} format.
        :param pulumi.Input[_builtins.str] password: The user login password.
        :param pulumi.Input[_builtins.str] phone: The user phone.
        :param pulumi.Input[_builtins.str] service_key: The service key for service account.
        :param pulumi.Input[_builtins.str] source: Source means where the user comes from. For now we support Entra ID SCIM sync, so the source could be Entra ID.
        :param pulumi.Input[_builtins.str] state: The user is deleted or not.
        :param pulumi.Input[_builtins.str] title: The user title.
        :param pulumi.Input[_builtins.str] type: The user type, should be USER or SERVICE_ACCOUNT. Cannot change after creation.
        """
    ...
    def last_change_password_time(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def last_change_password_time(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class User(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="lastChangePasswordTime")
    def last_change_password_time(self) -> pulumi.Output[_builtins.str]:
        """
        The user last change password time.
        """
        return pulumi.get(self, "last_change_password_time")
