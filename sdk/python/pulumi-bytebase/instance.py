...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 activation: Optional[pulumi.Input[_builtins.bool]] = None,
                 external_link: Optional[pulumi.Input[_builtins.str]] = None,
                 list_all_databases: Optional[pulumi.Input[_builtins.bool]] = None,
                 maximum_connections: Optional[pulumi.Input[_builtins.int]] = None,
                 sync_interval: Optional[pulumi.Input[_builtins.int]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] engine: The instance engine. Support MYSQL, POSTGRES, TIDB, SNOWFLAKE, CLICKHOUSE, MONGODB, SQLITE, REDIS, ORACLE, SPANNER, MSSQL, REDSHIFT, MARIADB, OCEANBASE, COCKROACHDB.
        :param pulumi.Input[_builtins.str] environment: The environment full name for the instance in environments/{environment id} format.
        :param pulumi.Input[_builtins.str] resource_id: The instance unique resource id.
        :param pulumi.Input[_builtins.str] title: The instance title.
        :param pulumi.Input[_builtins.bool] activation: Whether assign license for this instance or not.
        :param pulumi.Input[_builtins.str] external_link: The external console URL managing this instance (e.g. AWS RDS console, your in-house DB instance console)
        :param pulumi.Input[_builtins.bool] list_all_databases: List all databases in this instance. If false, will only list 500 databases.
        :param pulumi.Input[_builtins.int] maximum_connections: The maximum number of connections.
        :param pulumi.Input[_builtins.int] sync_interval: How often the instance is synced in seconds. Default 0, means never sync.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def activation(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @activation.setter
    def activation(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "activation", value)

    @_builtins.property
    @pulumi.getter(name="externalLink")
    def external_link(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def external_link(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "external_link", value)

    @_builtins.property
    @pulumi.getter(name="listAllDatabases")
    def list_all_databases(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def list_all_databases(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "list_all_databases", value)

    @_builtins.property
    @pulumi.getter(name="maximumConnections")
    def maximum_connections(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def maximum_connections(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "maximum_connections", value)

    @_builtins.property
    @pulumi.getter(name="syncInterval")
    def sync_interval(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def sync_interval(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] engine: The instance engine. Support MYSQL, POSTGRES, TIDB, SNOWFLAKE, CLICKHOUSE, MONGODB, SQLITE, REDIS, ORACLE, SPANNER, MSSQL, REDSHIFT, MARIADB, OCEANBASE, COCKROACHDB.
        :param pulumi.Input[_builtins.str] engine_version: The engine version.
        :param pulumi.Input[_builtins.str] environment: The environment full name for the instance in environments/{environment id} format.
        :param pulumi.Input[_builtins.str] external_link: The external console URL managing this instance (e.g. AWS RDS console, your in-house DB instance console)
        :param pulumi.Input[_builtins.bool] list_all_databases: List all databases in this instance. If false, will only list 500 databases.
        :param pulumi.Input[_builtins.int] maximum_connections: The maximum number of connections.
        :param pulumi.Input[_builtins.str] name: The instance full name in instances/{resource id} format.
        :param pulumi.Input[_builtins.str] resource_id: The instance unique resource id.
        :param pulumi.Input[_builtins.int] sync_interval: How often the instance is synced in seconds. Default 0, means never sync.
        :param pulumi.Input[_builtins.str] title: The instance title.
        """
...
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_id: Optional[pulumi.Input[_builtins.str]] = None,
            sync_interval: Optional[pulumi.Input[_builtins.int]] = None,
            title: Optional[pulumi.Input[_builtins.str]] = None) -> 'Instance':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def activation(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether assign license for this instance or not.
        """
        return pulumi.get(self, "activation")
    ...
    @_builtins.property
    @pulumi.getter(name="externalLink")
    def external_link(self) -> pulumi.Output[_builtins.str]:
        """
        The external console URL managing this instance (e.g. AWS RDS console, your in-house DB instance console)
        """
        return pulumi.get(self, "external_link")
    ...
    @_builtins.property
    @pulumi.getter(name="listAllDatabases")
    def list_all_databases(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        List all databases in this instance. If false, will only list 500 databases.
        """
        return pulumi.get(self, "list_all_databases")
    ...
    @_builtins.property
    @pulumi.getter(name="maximumConnections")
    def maximum_connections(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum number of connections.
        """
        return pulumi.get(self, "maximum_connections")
    ...
    @_builtins.property
    @pulumi.getter(name="syncInterval")
    def sync_interval(self) -> pulumi.Output[_builtins.int]:
        """
        How often the instance is synced in seconds. Default 0, means never sync.
        """
        return pulumi.get(self, "sync_interval")
