...
class PolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] parent: The policy parent name for the policy, support projects/{resource id}, environments/{resource id}, instances/{resource id}, or instances/{resource id}/databases/{database name}
        :param pulumi.Input[_builtins.str] type: The policy type.
        ...
        :param pulumi.Input[_builtins.bool] enforce: Decide if the policy is enforced.
        :param pulumi.Input[_builtins.bool] inherit_from_parent: Decide if the policy should inherit from the parent.
...
class _PolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enforce: Decide if the policy is enforced.
        :param pulumi.Input[_builtins.bool] inherit_from_parent: Decide if the policy should inherit from the parent.
        :param pulumi.Input[_builtins.str] name: The policy full name
        :param pulumi.Input[_builtins.str] parent: The policy parent name for the policy, support projects/{resource id}, environments/{resource id}, instances/{resource id}, or instances/{resource id}/databases/{database name}
        :param pulumi.Input['PolicyRolloutPolicyArgs'] rollout_policy: Control issue rollout. Learn more: https://docs.bytebase.com/administration/environment-policy/rollout-policy
        :param pulumi.Input[_builtins.str] type: The policy type.
        """
...
class Policy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="inheritFromParent")
    def inherit_from_parent(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Decide if the policy should inherit from the parent.
        """
        return pulumi.get(self, "inherit_from_parent")
