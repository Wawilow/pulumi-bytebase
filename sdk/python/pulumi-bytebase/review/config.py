...
class ConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enabled: Enable the SQL review config
        :param pulumi.Input[_builtins.str] resource_id: The unique resource id for the review config.
        :param pulumi.Input[Sequence[pulumi.Input['ConfigRuleArgs']]] rules: The SQL review rules.
        :param pulumi.Input[_builtins.str] title: The title for the review config.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resources: Resources using the config. We support attach the review config for environments or projects with format {resurce}/{resource id}. For example, environments/test, projects/sample.
        """
...
class Config(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resources: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ConfigRuleArgs', 'ConfigRuleArgsDict']]]]] = None,
            title: Optional[pulumi.Input[_builtins.str]] = None) -> 'Config':
        """
