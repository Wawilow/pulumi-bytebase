...
def get_environment(color: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_id: The environment unique resource id.
    """
    __args__ = dict()
...
def get_environment_output(color: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           protected: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
