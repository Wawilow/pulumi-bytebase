...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] email: The group email.
        :param pulumi.Input[Sequence[pulumi.Input['GroupMemberArgs']]] members: The members in the group.
        :param pulumi.Input[_builtins.str] title: The group title.
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] email: The group email.
        :param pulumi.Input[Sequence[pulumi.Input['GroupMemberArgs']]] members: The members in the group.
        :param pulumi.Input[_builtins.str] name: The group name in groups/{email} format.
        :param pulumi.Input[_builtins.str] source: Source means where the group comes from. For now we support Entra ID SCIM sync, so the source could be Entra ID.
        :param pulumi.Input[_builtins.str] title: The group title.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
