...
class GetListResult:
    ...
    @_builtins.property
    @pulumi.getter
    def roles(self) -> Sequence['outputs.GetListRoleResult']:
...
def get_list(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetListResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytebase:Role/getList:getList', __args__, opts=opts, typ=GetListResult).value
...
def get_list_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetListResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytebase:Role/getList:getList', __args__, opts=opts, typ=GetListResult)
