...
class RoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] permissions: The role permissions. Permissions should start with "bb." prefix. Check https://github.com/bytebase/bytebase/blob/main/backend/component/iam/permission.yaml for all permissions.
        :param pulumi.Input[_builtins.str] resource_id: The role unique resource id.
        :param pulumi.Input[_builtins.str] title: The role title.
        :param pulumi.Input[_builtins.str] description: The role description.
        """
...
class _RoleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: The role description.
        :param pulumi.Input[_builtins.str] name: The role full name in roles/{resource id} format.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] permissions: The role permissions. Permissions should start with "bb." prefix. Check https://github.com/bytebase/bytebase/blob/main/backend/component/iam/permission.yaml for all permissions.
        :param pulumi.Input[_builtins.str] resource_id: The role unique resource id.
        :param pulumi.Input[_builtins.str] title: The role title.
        :param pulumi.Input[_builtins.str] type: The role type.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if name is not None:
